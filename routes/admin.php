...
use App\Http\Controllers\Admin\PendingProductsController;
...
Route::get('/admin/category/add', [CategoryController::class,'add_new_category'])->middleware('admin')->name('admin.category.add');
Route::get('/admin/category/edit/{id}', [CategoryController::class,'category_edit'])->middleware('admin')->name('admin.category.edit');
Route::post('/admin/category/update', [CategoryController::class,'category_update'])->middleware('admin')->name('admin.category.update');
Route::post('/admin/category/delete', [CategoryController::class,'category_delete'])->middleware('admin')->name('admin.category.delete');

// Pending Products Route 
Route::get('/admin/pending-products', [PendingProductsController::class,'index'])->middleware('admin')->name('admin.product.seller.request');
Route::get('/admin/pending-products/edit/{id}', [PendingProductsController::class,'edit'])->middleware('admin')->name('admin.pending.products.edit');
Route::post('/admin/pending-product/update/{id}', [PendingProductsController::class,'update'])->middleware('admin')->name('admin.product.RequestProSave');
Route::get('/admin/pending-products/delete/{id}', [PendingProductsController::class,'destroy'])->middleware('admin')->name('admin.pending.products.delete');


// Brand Route 
Route::post('/admin/brands/store', [BrandsController::class,'admin_brands_store'])->middleware('admin')->name('admin.brand.store');
Route::get('/admin/brands/edit/{id}', [BrandsController::class,'admin_brands_edit'])->middleware('admin')->name('admin.brand.edit');
Route::post('/admin/brands/update', [BrandsController::class,'admin_brand_updated'])->middleware('admin')->name('admin.brand.updated');
Route::post('/admin/brands/delete', [BrandsController::class,'admin_brands_delete'])->middleware('admin')->name('admin.brands.delete');


// Product Route 
Route::post('/admin/products/store', [ProductController::class,'admin_products_store'])->middleware('admin')->name('admin.products.store');
Route::post('/admin/products/update/', [ProductController::class,'admin_products_update'])->middleware('admin')->name('admin.products.update');
Route::post('/admin/products/delete', [ProductController::class,'admin_product_delete'])->middleware('admin')->name('admin.products.delete');

Route::get('/admin/products/get_brand_category/{id}', [ProductController::class,'admin_products_get_brand_category'])->middleware('admin')->name('admin.products.get.brand.category');
Route::get('/admin/products/get_sub_category/{id}', [ProductController::class,'admin_products_get_sub_category'])->middleware('admin')->name('admin.products.get.sub.category');


// Sub Category Route 
Route::get('/admin/sub-category/add', [SubCategoryController::class,'admin_sub_category_add'])->middleware('admin')->name('admin.sub.category.add');
Route::post('/admin/subs-category/store', [SubCategoryController::class,'admin_sub_category_store'])->middleware('admin')->name('admins.subs.category.store');
Route::get('/admin/subs-category/edit/{id}', [SubCategoryController::class,'admin_sub_category_edit'])->middleware('admin')->name('admins.sub.category.edit');
Route::post('/admin/subs-category/update', [SubCategoryController::class,'admin_sub_category_update'])->middleware('admin')->name('admins.sub.category.update');
Route::post('/admin/subs-category/delete', [SubCategoryController::class,'admin_sub_category_delete'])->middleware('admin')->name('admins.sub.category.delete');


// Admin Chat Route 
Route::get('/admin/cusomters/messages', [SupportTicketController::class,'admin_customers_messages'])->middleware('admin')->name('admin.customers.messages');
Route::get('/admin/cusomters/messages/{id}', [SupportTicketController::class,'admin_customer_chat_view'])->middleware('admin')->name('admin.customer.chat');
Route::post('/admin/cusomters/messages/store', [SupportTicketController::class,'admin_customer_message_store'])->middleware('admin')->name('admin.customer.message.store');


Route::post('/admin/cusomters/messages/delete', [SupportTicketController::class,'admin_customer_chat_delete'])->middleware('admin')->name('admin.customer.chat.delete');


Route::get('/admin/sellers/messages', [SupportTicketController::class,'admin_sellers_messages'])->middleware('admin')->name('admin.sellers.messages');

// Wallet Route
Route::get('/admin/sellers/wallet', [WalletController::class,'index'])->middleware('admin')->name('admin.sellers.wallet');


// Commissions Route
Route::post('/admin/commoissions/store', [SystemController::class,'admin_commissions_store'])->name('admin.commissions.store');


// Customers Route

Route::post('/admin/customer/fetch', [CustomerController::class,'admin_customer_fetch'])->name('admin.customer.fetch');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'sub-sub-category', 'as' => 'sub-sub-category.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('add', 'SubSubCategoryController@add')->name('add');
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('new-seller-list', 'SellerController@new_index')->name('new-seller-list');
