...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        //add me only تم اضافتها من قبلي 
        Route::post('registerorlogin', 'PassportAuthController@registerorlogin');

        Route::post('check-phone', 'PhoneVerificationController@check_phone');
        Route::post('check_phone_order', 'PhoneVerificationController@check_phone_order');
        Route::post('verify-phone', 'PhoneVerificationController@verify_phone');
        Route::post('verify_phone_order', 'PhoneVerificationController@verify_phone_order');
    ...
    Route::group(['prefix' => 'brands'], function () {
        ...
        Route::get('products', 'BrandController@get_products');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::put('update-profile-doc', 'CustomerController@update_profile_doc');
        ...
        Route::group(['prefix' => 'new-req-order'], function () {
            Route::post('create', 'CustomerController@create_new_req_order');
            Route::get('get', 'CustomerController@get_new_req_orders');
            Route::get('conv/{ticket_id}', 'CustomerController@get_new_req_order_conv');
            Route::post('reply/{ticket_id}', 'CustomerController@reply_new_req_order');
        });
    ...
    Route::group(['prefix' => 'customer'], function() {
        ...
        Route::get('wallet', 'CustomerController@customer_wallet');
        Route::get('wallet/history', 'CustomerController@customer_wallet_history');
