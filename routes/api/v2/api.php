...
Route::group(['namespace' => 'api\v2', 'prefix' => 'v2', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'delivery-man', 'namespace' => 'delivery_man'], function () {
        ...
        Route::group(['middleware' => ['delivery_man_auth']], function () {
            ...
            Route::get('last-orders', 'DeliveryManController@get_last_orders');
            Route::post('get-last-orders-status', 'DeliveryManController@get_last_orders_status');
            Route::get('current-orders', 'DeliveryManController@get_current_orders');
           
            Route::post('order-delivered', 'DeliveryManController@get_order_delivered');
            Route::get('wallet', 'DeliveryManController@wallet');
            Route::get('order-history', 'DeliveryManController@order_history');
            Route::post('order-delivery-history', 'DeliveryManController@get_order_history');
