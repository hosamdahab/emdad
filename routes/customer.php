...
Route::get('customer/login-phone-verify', [LoginController::class,'login_phone_verify'])->name('customer.login.phone.verify');
Route::post('customer/login-phone-verify', [LoginController::class,'login_submit_phone_token']);
