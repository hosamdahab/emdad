...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $getSeller = DB::table('sellers')->where('id', '=', auth('seller')->id())->first();

        if(isset($getSeller)) {

            $getOrders = OrderDetail::where([
                ['seller_id', '=', auth('seller')->id()],
        ...
        return view('seller-views.system.dashboard', compact('data','days','days_amount' ,'seller_data', 'commission_data','todayAmount','customers', 'getOrders'));
    }
