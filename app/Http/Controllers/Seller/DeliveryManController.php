...
class DeliveryManController extends Controller
{
    ...
    public function seller_delivery_payment(Request $request) {

        $myId = $request->delivery_man_id;

        Order::where('delivery_man_id', '=', $myId)->update([
        ...
        $check_delivery = Order::where('delivery_man_id', '=', $myId)->get();

      
        foreach($check_delivery as $val) {

            $result = OrderDetail::where('order_id','=', $val->id)->update([
        ...
        Toastr::success('تم تسوية الرصيد بنجاح');
        return redirect()->back();
    }


    public function seller_delivery_edit($id) {

        $delivery = DeliveryMan::find($id);
        return view('seller-views.shipping-method.edit_delivery', compact('delivery'));
    }



    public function seller_delivery_update(Request $request) {
        ...
        Toastr::success('تم تعديل بيانات الموصل بنجاح');
        return redirect()->back();
    }


    public function seller_delivery_delete(Request $request) {

        $myId = $request->myId;

        $DeliveryMan = DeliveryMan::where('id', '=', $myId)->delete();

        Toastr::success('تم حذف بيانات الموصل بنجاح');
        return redirect()->back();
