...
class ZoneController extends Controller
{
    ...
    {
        $zones = Zone::withCount(['shop','deliverymen'])->latest()->paginate(config('default_pagination'));
        return view('seller-views.zone.index', compact('zones'));
    }
    ...
    public function edit($id)
    {
        ...
        // dd($zone->coordinates);
        return view('seller-views.zone.edit', compact('zone'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('seller-views.zone.partials._table',compact('zones'))->render(),
            'total'=>$zones->count()
        ]);
    }
