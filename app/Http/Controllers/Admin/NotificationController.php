...
class NotificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $fcm_token = User::whereNotNull('cm_firebase_token')->get();
            foreach($fcm_token as $userfcm) {
                $appuserfcm_token = User::where('id', $userfcm->id)->pluck('cm_firebase_token')->first();
                $data = [
                ...
                Helpers::send_push_notif_to_device($appuserfcm_token, $data);
            }
