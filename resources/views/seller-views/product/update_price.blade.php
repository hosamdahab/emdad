        ...
        <div class="top" style="padding:20px 0;border-radius:20px">
            <div class="row" style="align-items:center;justify-content:space-between">
                ...
                <div class="col-md-5" style="display:flex;justify-content:end;margin-left:2rem">
                    ...
                    <i class="fa-solid fa-upload fa-xl" style="color:#fff"></i>
                    </section>
        ...
        <div class="bottom" style="padding:20px 0;border-radius:20px">
            <div class="row" style="margin-right:2rem">
                ...
                <div class="col-md-2" style="box-shadow:5px 5px 5px #ccc;text-align:center;margin:10px 0;padding:20px">
                    ...
                    <!-- Start Form Upload --> 
                    <form action="{{route('seller.product.file.update')}}" id="excel_file" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="element">
                        <i class="fa-solid fa-upload fa-xl"></i><p class="name">ارفع ملف التعديلات</p>
                ...
                <br>
                <div class="col-md-3">
                <button class="btn btn-primary" form="excel_file" id="excel_file_submit" disabled formaction="{{route('seller.product.file.update')}}">{{__('messages.save')}}</button>
                </div>
...
$(document).ready(function() {
        ...
        $("i").click(function () {
            ...
            $('#excel_file_submit').attr('disabled', null);
        });
