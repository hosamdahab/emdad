...
<div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('delivery_report')}}</li>
            </ol>
        </nav>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <section id="section_one">
                    ...
                    @php($delivery =\App\Model\DeliveryMan::where(['seller_id'=>auth('seller')->id()])->get())
                        <select name="delivery" onchange="get_delivery()" id="delivery" class="col-4 form-control">
                            <option selected>حدد الموصل</option>
                    ...
                    <div class="row" id="delivery_report_section">
                        ...
                        <div class="col-4 bg-success text-white">
                            <a href="{{route('sales.of.month.delivery.invoices')}}" class="text-white">
...
<script>
        ...
        function get_delivery(){
            ...
            var myDelivery = document.getElementById('delivery').value;
                ...
                $.ajax({
                type:'POST',
                url: "{{ route('seller.sales.delivery.chart') }}",
                data:{myDelivery:myDelivery},
