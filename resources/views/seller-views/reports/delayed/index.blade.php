...
<div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('deferred_sale')}}  </li>
            </ol>
        </nav>
                ...
                <section id="section_one">
                    <div class="row">
                        ...
                        <div class="col-3 bg-success text-white">
                            <a href="{{route('delayed.sales.month.invoices')}}" class="text-white">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            type:'GET',
            url: "{{ route('seller.sales.deffered.chart') }}",
