...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            ...
            <form action="{{route('seller.zone.update', $zone->id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-6">
...
@push('script_2')
<script src="https://maps.googleapis.com/maps/api/js?v=3.45.8&key=AIzaSyDpfS1oRGreGSBU5HHjMmQ3o5NLw7VdJ6I&libraries=drawing,places"></script>
<script>
    auto_grow();
    function auto_grow() {
...
<script>
    ...
    {
        $.get({
            url: '{{route('seller.zone.zoneCoordinates')}}/{{$zone->id}}',
            dataType: 'json',
