    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('seller.zone.store')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @foreach($zones as $key=>$zone)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('seller.zone.status',[$zone['id'],$zone->status?0:1])}}" method="get" id="status-{{$zone['id']}}">
                                        </form>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('seller.zone.edit',[$zone['id']])}}" title="{{__('messages.edit')}} {{__('messages.zone')}}"><i class="tio-edit"></i>
                                        </a>
                                        ...
                                        <form action="{{route('seller.zone.delete',[$zone['id']])}}" method="post" id="zone-{{$zone['id']}}">
                                            @csrf @method('delete')
                                        </form>--}}
                                    </td>
                                </tr>
...
@push('script_2')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDpfS1oRGreGSBU5HHjMmQ3o5NLw7VdJ6I&libraries=drawing,places&v=3.45.8"></script>
