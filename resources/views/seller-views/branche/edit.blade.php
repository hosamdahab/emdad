        ...
        <div class="col-md-12">
            <div class="card">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title" style="padding:20px"><i class="tio-add-circle-outlined"></i>تحديث معلومات الفرع</h1>
                </div>
                <div class="card-body">
                    <form action="{{route('seller.branches.update')}}" method="post" id="seller_branch_update"
                          style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        @csrf
                            

                        <input type="hidden" name="myId" value="{{$branche->id}}">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_mobile" value="{{$branche->phone_mobile}}" class="form-control" placeholder="********967"   maxlength="9"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled name="manager_phone" value="{{$branche->manager_phone}}" class="form-control" maxlength="9"
                                        placeholder="********967"
                                        required>
                                </div>
                            </div>
