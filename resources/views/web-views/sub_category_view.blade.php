...
@section('content')
   ...
   <div class="row">
        <div class="col-12" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <p style="margin:40px 40px 0px 40px;font-weight: 600;font-size: 18px;">{{$sub_sub_category->name}}</p>
                </div>
                        ...
                        <div class="col-md-6 m-2 m-md-0 d-flex  align-items-center ">
                            ...
                            <div class="" style="width: 100%">
                                <form id="filters-search-form" action="{{ route('product.filters.serach') }}" method="POST">
                                    ...
                                    <input type="hidden" name="category_ids" id="category_ids" value="{{$sub_sub_category->id}}">
                                </form>
                            </div>
                        </div>
                    </div>
