...
@section('content')
   ...
   <div class="row">
        <div class="col-12" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <p style="margin:40px 40px 0px 40px;font-weight: 600;font-size: 18px;">{{\App\CPU\translate('rate_purchasing')}}</p>
                </div>
                ...
                {{-- </div> --}}
                   ...
                   <!-- Get Products -->
                    ...
                    <div class="row" id="pro_row">
                       ...
                       $sub_category = DB::table('subs_categories')->where('id','=', $pro->sub_category_id)->first();
                       ...
                       <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('add.to.cart')}}" method="post" id="category_pro_add_cart">
                                    ...
                                    @isset($shop_info->name)
                                    <input type="hidden" name="shop_info" value="{{$shop_info->name}}">
                                    @endisset

                                    @empty($shop_info->name)
                                    <input type="hidden" name="shop_info" value="الفرع الرئيسي">
                                    @endempty
