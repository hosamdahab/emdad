        ...
        <div class=" d-flex" style="">
            <div class=" d-flex align-items-center justify-content-center"
                ...
                <div class="flash-deals-background-image" style="background: {{$web_config['primary_color']}}10">
                     ...
                     <img src="{{asset('product/'.$product->thumbnail)}}" class="cz-image-zoom img-responsive" style="height: 125px!important;width:125px!important;border-radius:5px;"
                     onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"  alt="Product image" width="">
                </div>
            </div>
