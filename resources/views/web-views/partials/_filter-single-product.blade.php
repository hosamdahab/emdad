...
<div class="product-single-hover" style="">
    <div class=" inline_product clickable d-flex justify-content-center" 
        ...
        <div class="d-flex d-block" style="cursor: pointer;">
            <a href="{{route('product',['slug' => $product->slug])}}">
                    ...
                    <img src="{{asset('product/'.$product->thumbnail)}}" alt="" onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
    ...
    <div class="text-center quick-view" style="border-radius:0px 0px 5px 5px;">
        @if(Request::is('product/*'))
            <a class="btn btn-primary btn-sm" href="{{route('product',['slug' => $product->slug])}}">
