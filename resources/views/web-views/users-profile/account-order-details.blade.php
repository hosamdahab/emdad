                        ...
                        <table class="table table-borderless">
                            ...
                            @foreach ($order->details as $key=>$detail)
                                ...
                                <tr>
                                    <div class="row">
                                        <div class="col-md-6"
                                             onclick="location.href='{{route('product',$product['id'])}}'">
                                            ...
                                            <td class="col-10 for-glaxy-name" style="vertical-align:middle;">
                                                ...
                                                @php($Brand = DB::table('brands')->where('id', '=', $product['brand_id'])->first())
                                                {{$Brand->name}}  @isset($sub_sub_category->name) {{$sub_sub_category->name}} @endisset  {{$product['product_type']}}
                                        ...
                                        <div class="col-md-4">
                                            <td width="100%">
                                                <div
                                                    ...
                                                    <span
                                                        class="font-weight-bold amount d-flex">{{number_format($product['unit_price'],2)}} <span style="margin:0 5px"> ريال </span></span>
