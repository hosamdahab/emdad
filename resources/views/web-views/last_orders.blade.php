    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row">
            ...
            <div class="col-md-12 mt-2 sidebar_heading">
                <h1 class="h3  mb-0 p-3 float-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} headerTitle">{{__('messages.latest_orders')}}</h1>
            </div>
        </div>
    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td class="bodytr orderDate"><span class="">{{$myDate}}</span></td>
                                    <td class="bodytr">
                                        ...
                                        @elseif($order['payment_status']=='confirmed' || $order['payment_status']=='processing' || $order['payment_status']=='delivered')
