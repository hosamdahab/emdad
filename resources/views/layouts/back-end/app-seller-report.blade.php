...
@include('layouts.back-end.partials-seller.report_side_bar')
        ...
        $('#orderAccept').submit(function(e){
                ...
                // console.log('good');
                    ...
                    $('#automaticOrdersDelete').change(function() {
                        // this will contain a reference to the checkbox   
                        var remember = document.getElementById('automaticOrdersDelete');
                        if (!remember.checked){
                    ...
                    $('#delivery_man_select').submit(function(e){
                    ...
                    $('#deferred_sale_form').submit(function(e){
                        ...
                        $.ajax({
                          ...
                          $('#deferred_sale_form_deletes').submit(function(e){
                                    ...
                                    success: (response) => {
                                        if (response) {
                                            ...
                                            Swal.fire(
                                                ...
                                                window.location.href = '/seller/branches/list'
                                        }
                                    },
                                    error: function(response){
                                        $('#image-input-error').text(response.responseJSON.message);
                            ...
                            $('#workTime_branch_id').on('change',function(){

                                var branch_id = $("#workTime_branch_id").val();

                                $.ajax({
                                    type:'POST',
                                    url: "{{ route('seller.branche.work.time.select') }}",
                                    data:{branch_id:branch_id},
                                    success:function(response){

                                        if(response.saturday != null) {

                                                $('#saturday').attr('checked', true);
                                                $('#saturday_from_time').val('' + response.saturday.from_hours + ':' + response.saturday.from_minutes +'');
                                                $('#saturday_to_time').val('' + response.saturday.to_hours + ':' + response.saturday.to_minutes +'');
                                                ...
                                                $('#saturday').change(function() {
                                                    ...
                                                    //    console.log('checked')
                                                        ...
                                                        $('#saturday_from_time').val(null);
                                                        $('#saturday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.saturday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Saturday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                                        ...
                                        if(response.sunday != null) {

                                            $('#sunday').attr('checked', true);
                                            $('#sunday_from_time').val('' + response.sunday.from_hours + ':' + response.sunday.from_minutes +'');
                                            $('#sunday_to_time').val('' + response.sunday.to_hours + ':' + response.sunday.to_minutes +'');
                                                ...
                                                $('#sunday').change(function() {
                                                    ...
                                                    //    console.log('checked')
                                                        ...
                                                        $('#sunday_from_time').val(null);
                                                        $('#sunday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.sunday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Sunday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                                        ...
                                        if(response.monday != null) {

                                        $('#monday').attr('checked', true);
                                        $('#monday_from_time').val('' + response.monday.from_hours + ':' + response.monday.from_minutes +'');
                                        $('#monday_to_time').val('' + response.monday.to_hours + ':' + response.monday.to_minutes +'');
                                            ...
                                            $('#monday').change(function() {
                                                    ...
                                                    if (remember.checked){
                                                        ...
                                                        $('#monday_from_time').val(null);
                                                        $('#monday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.monday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Monday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                                        ...
                                        if(response.tuesday != null) {

                                        $('#tuesday').attr('checked', true);
                                        $('#tuesday_from_time').val('' + response.tuesday.from_hours + ':' + response.tuesday.from_minutes +'');
                                        $('#tuesday_to_time').val('' + response.tuesday.to_hours + ':' + response.tuesday.to_minutes +'');
                                            ...
                                            $('#tuesday').change(function() {
                                                    ...
                                                    if (remember.checked){
                                                        ...
                                                        $('#tuesday_from_time').val(null);
                                                        $('#tuesday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.tuesday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Tuesday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                                        ...
                                        if(response.wednesday != null) {

                                        $('#wednesday').attr('checked', true);
                                        $('#wednesday_from_time').val('' + response.wednesday.from_hours + ':' + response.wednesday.from_minutes +'');
                                        $('#wednesday_to_time').val('' + response.wednesday.to_hours + ':' + response.wednesday.to_minutes +'');
                                            ...
                                            $('#wednesday').change(function() {
                                                    ...
                                                    if (remember.checked){
                                                        ...
                                                        $('#wednesday_from_time').val(null);
                                                        $('#wednesday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.wednesday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Wednesday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                                        ...
                                        if(response.thursday != null) {

                                        $('#thursday').attr('checked', true);
                                        $('#thursday_from_time').val('' + response.thursday.from_hours + ':' + response.thursday.from_minutes +'');
                                        $('#thursday_to_time').val('' + response.thursday.to_hours + ':' + response.thursday.to_minutes +'');
                                            ...
                                            $('#thursday').change(function() {
                                                    ...
                                                    if (remember.checked){
                                                        ...
                                                        $('#thursday_from_time').val(null);
                                                        $('#thursday_to_time').val(null);
                                                        
                                                        $.ajax({
                                                            type:'POST',
                                                            url: "{{ route('seller.work.time.thursday.delete') }}",
                                                            data:{branch_id:branch_id},
                                                            success:function(response){
                                                            console.log('Thursday Deleted')
                                                            },
                                                            error: function(response){
                                                                $('#image-input-error').text(response.responseJSON.message);
                                                            }
                            ...
                            $('#branche_select_employees').on('change', function(){

                                   let branch_id = $('#branche_select_employees').val();

                                   $('#branch_id_add_employees').val(branch_id);


                                $.ajax({
                                    type:'POST',
                                    url: "{{ route('seller.branch.employees.select') }}",
                                    data:{branch_id:branch_id},
                                    success:function(response){

                                        $('#seller_employees_table').empty().append();
                                        if(response) {

                                            $.each(response.employees,function(key,value){
                                        $('#seller_employees_table').append('<tr>\
                                        <td>' + value.name + '</td>\
                                        <td>' + value.email + '</td>\
                                        <td>' + value.phone + '</td>\
                                        <td>' + value.position + '</td>\
                                        <td>\
                                            <a href="/seller/employees/edit/' + value.id +'" class="btn btn-primary btn-sm" style="background: #645cb3;border:none;">\
                                                <i class="fa fa-edit"></i>\
                                            </a>\
                                            <form action="{{route("seller.delete.employees")}}" method="post" class="employees_delete_form">\
                                            @csrf \
                                            <input type="hidden" name="myId" value="' + value. id + '">\
