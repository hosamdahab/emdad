            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--order management ends-->
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category/*') ||Request::is('admin/category/*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/category/*') ||Request::is('admin/category/*'))?'block':''}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/sub-category/*') ||Request::is('admin/sub-category/*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/sub-category/view') ||Request::is('admin/sub-category/*'))?'block':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/sub-category/add')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.sub.category.add')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('add_new')}}</span>
                                        </a>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/sub-sub-category/*') ||Request::is('admin/sub-sub-category/*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{__('messages.Sub Sub Category')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/sub-sub-category/view') ||Request::is('admin/sub-sub-category/*'))?'block':''}}">
                                    <li class="nav-item {{Request::is('admin/sub-category/view')?'active':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/sub-sub-category/add')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.sub-sub-category.add')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('add_new')}}</span>
                                        </a>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/product/list/seller*')||Request::is('admin/product/updated-product-list')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/pending-products')?'active':''}}">
                                        <a class="nav-link "
                                           href="{{route('admin.product.seller.request')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{__('messages.pending_products')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('user_section'))
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/seller*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/sellers/new-seller-list')?'active':''}}">
                                        <a class="nav-link"
                                           href="{{route('admin.sellers.new-seller-list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate d-flex justify-content-between">
                                                {{\App\CPU\translate('pending seller')}}
                                                <strong class="text-danger px-3">
                                                    ( {{count(\App\Model\Seller::where("status","pending")->get())}} )
                                                </strong>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item {{Request::is('admin/sellers/wallet')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.sellers.wallet')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{__('messages.Wallet')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                          ...
                          <!-- Pages -->
                            <li class="nav-item {{(Request::is('admin/currency/view') ||Request::is('admin/business-settings/refund*') || Request::is('admin/business-settings/language*') || Request::is('admin/business-settings/shipping-method*') || Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/seller-settings*'))?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/commoissions')?'active':''}}">
                                        <button style="border:none;background:none;color:#377dff" data-toggle="modal" data-target=".example-modal">
                                            <i class="tio-dollar-outlined nav-icon"></i>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                {{\App\CPU\translate('commissions')}}
                                            </span>
                                        </button>
                                    </li>
                        ...
                        <!-- @if(\App\CPU\Helpers::module_permission_check('delivery_man_management')) -->
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/delivery-man*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/delivery-man*')?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/delivery-man/add')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.customers.messages')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Customer')}}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{Request::is('admin/delivery-man/list')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.sellers.messages')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('sellers')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
...
@include('layouts.back-end.partials.commissions')
