...
<script>
    ...
    $(document).ready(function(){
        ...
        var ckbox = $(".category-status");
        var chkId = '';
        $('.category-status').on('click', function() {
    
        if (ckbox.is(':checked')) {
        $(".category-status:checked").each ( function() {
   			chkId = $(this).attr('id');
    ...
    //    alert ( $(this).val() ); // return all values of checkboxes checked
       alert(chkId); // return value of checkbox checked
        ...
        let status = $('.category-status').is(":checked");

        // console.log(status);

        $('#admin_commissions').submit(function(e){
