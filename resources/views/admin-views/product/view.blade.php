                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img
                                ...
                                alt="Image Description" draggable="false">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <div class="flex-start">
                            ...
                            <span
                                class="mx-1">{{$product->unit_price.'.00 ريال'}}</span>
                        </div>
                        <div class="flex-start">
                        ...
                        <div class="flex-start">
                            ...
                            <span
                                class="mx-1">{{$product->discount.'%'}}</span>
                        </div>
                        <div class="flex-start">
                            <span>{{\App\CPU\translate('shipping Cost')}} : </span>
                            <span class="mx-1">{{$product->shipping_cost.'.00 ريال'}}</span>
                        </div>
                        <div class="flex-start">
                             ...
                             <div class="col-md-3">
                                 <div class="card">
                                     <div class="card-body">
                                         <img style="width: 100%"
                                              onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                              src="{{asset('product/'.$product->images)}}" draggable="false" alt="Product image">
