...
@section('title', 'اضافة قسم فرعي الفرعي')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.sub-sub-category.store')}}" method="POST" enctype="multipart/form-data" id="subSubCategoryStore1">
                            @csrf 
                                ...
                                <div class="col-lg-6 col-md-5 col-12">
                                        ...
                                        <div class="form-group lang_form"
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                   placeholder="{{__('messages.Sub Sub Category')}} {{\App\CPU\translate('name')}}">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-5 col-12">
                                    <div class="form-group">
                                        ...
                                        <select id="exampleFormControlSelect1" name="sub_category_id"
                                                class="form-control" required>
                                            @foreach(\App\Model\subsCategory::all() as $sub_category)
                                                <option
...
<script type="text/javascript">
    ...
    $('#subSubCategoryStore1').submit(function(e) {
        e.preventDefault();
