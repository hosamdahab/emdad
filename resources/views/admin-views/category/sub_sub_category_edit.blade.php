            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        ...
                        <form action="{{route('admin.sub-sub-category.update')}}" method="POST" enctype="multipart/form-data" id="subSubCategoryUpdate">
                                ...
                                <div class="col-lg-6 col-md-5 col-12">
                                        ...
                                        <div class="form-group lang_form"
                                            ...
                                            <label class="input-label"
                                                   ...
                                                   for="exampleFormControlInput1">{{__('messages.Sub Sub Category')}} {{\App\CPU\translate('name')}}
                                        ...
                                        <input type="hidden" name="old_icon" value="{{'sub_sub_category/'.$sub_categories->icon}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="exampleFormControlSelect1" name="category_id"
                                            ...
                                            @foreach(\App\Model\Category::all() as $category)
                                                ...
                                                <option {{ $category->id == $sub_categories->category_id ? 'selected' : '' }}
                                ...
                                <div class="col-lg-6 col-md-5 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="input-label"
                                               ...
                                               for="exampleFormControlSelect1">{{__('messages.sub_category')}}

                                            <span class="input-label-secondary">*</span></label>

                                        <select id="exampleFormControlSelect1" name="sub_category_id"

                                                class="form-control" required>

                                            @foreach(\App\Model\subsCategory::all() as $category)

                                                <option {{ $category->id == $sub_categories->sub_category_id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <center>
                                            ...
                                            <img
                                                ...
                                                src="{{asset('sub_sub_category/'.$sub_categories->icon)}}"
...
<script type="text/javascript">
    ...
    $('#subSubCategoryUpdate').submit(function(e) {
            ...
            success: (response) => {
                ...
                if (response) {
                    ...
                    Swal.fire(
                        ...
                        'تم تعديل القسم الفرعي الثالث'

                        )

                        window.location.href = '/admin/sub-sub-category/view'
