            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admins.subs.category.store')}}" method="POST" enctype="multipart/form-data" id="subCategoryStore1">
                            @csrf
...
<script type="text/javascript">
    ...
    $('#subCategoryStore1').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type:'POST',
            url: "{{route('admins.subs.category.store')}}",
            data: formData,
            contentType: false,
            processData: false,
            success: (response) => {
