                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="expire" class="form-control" id="expire" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="name">{{ \App\CPU\translate('min_purchasing')}}</label>
                                            <input type="number" name="min_purchasing" class="form-control" id="min_purchasing" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="title" id="" cols="30" rows="6"></textarea>
                                        </div>
