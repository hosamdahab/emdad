                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="name">{{ \App\CPU\translate('discount_code')}}</label>
                                            <input type="text" name="code" class="form-control" value="{{$banner['code']}}" id="code" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="name">{{ \App\CPU\translate('min_purchasing')}}</label>
                                            <input type="number" name="min_purchasing" value="{{$banner['min_purchasing']}}" class="form-control" id="min_purchasing" required>
                                        </div>


                                        <div class="form-group">
                                            <label for="name">{{ \App\CPU\translate('discount')}}</label>
                                            <input type="number" name="discount" class="form-control" value="{{$banner['discount']}}" id="discount" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="name">{{ \App\CPU\translate('banner_titles')}}</label>
                                            <textarea class="form-control" name="title" id="" cols="30" rows="6">{{$banner['title']}}</textarea>
                                        </div>
